...
const Butterandegg = () => {
            ...
            <div className="col-lg-12 text-center">
              <div className="breadcrumb__text">
                ...
                <div className="breadcrumb__option">
                  ...
                  <span className='breadcrumb__span'>    Butter & Eggs</span>
                </div>
              </div>
            </div>
          </div>
    ...
    <Row>
        ...
        <div className="product__discount__item">
          <div className="product__discount__item__pic set-bg" style={{ backgroundImage: 'url(images/department/butterandegg/butter01.jpg)',
          ...
          <div className="product__discount__item__text">
            <h5><a href="#">American Butter</a></h5>
      ...
      <Col lg={4} md={6} sm={12}>
        <div className="product__discount__item">
          <div className="product__discount__item__pic set-bg" style={{ backgroundImage: 'url(images/department/butterandegg/butter02.jpeg)',
                                                                                        backgroundSize: 'cover',
                                                                                        backgroundPosition: 'center',
                                                                                        width: '100%',
           }}>
      ...
      <Col lg={4} md={6} sm={12}>
        <div className="product__discount__item">
          <div className="product__discount__item__pic set-bg" style={{ backgroundImage: 'url(images/department/butterandegg/butter03.jpg)',
                                                                                        backgroundSize: 'cover',
                                                                                        backgroundPosition: 'center',
                                                                                        width: '100%',
           }}>
      ...
      <Col lg={4} md={6} sm={12}>
        <div className="product__discount__item">
          <div className="product__discount__item__pic set-bg" style={{ backgroundImage: 'url(images/department/butterandegg/egg01.jpg)',
                                                                                        backgroundSize: 'cover',
                                                                                        backgroundPosition: 'center',
                                                                                        width: '100%',
           }}>
      ...
      <Col lg={4} md={6} sm={12}>
        <div className="product__discount__item">
          <div className="product__discount__item__pic set-bg" style={{ backgroundImage: 'url(images/department/butterandegg/egg02.jpeg)',
                                                                                        backgroundSize: 'cover',
                                                                                        backgroundPosition: 'center',
                                                                                        width: '100%',
           }}>
      ...
      <Col lg={4} md={6} sm={12}>
        <div className="product__discount__item">
          <div className="product__discount__item__pic set-bg" style={{ backgroundImage: 'url(images/department/butterandegg/egg03.jpg)',
                                                                                        backgroundSize: 'cover',
                                                                                        backgroundPosition: 'center',
                                                                                        width: '100%',
           }}>
