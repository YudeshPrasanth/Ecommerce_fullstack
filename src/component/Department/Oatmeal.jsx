...
const Oatmeal = () => {
            ...
            <div className="col-lg-12 text-center">
              <div className="breadcrumb__text">
                ...
                <div className="breadcrumb__option">
                  ...
                  <span className='breadcrumb__span'>    Oatmeal</span>
                </div>
              </div>
            </div>
          </div>
    ...
    <Row>
        ...
        <div className="product__discount__item">
          <div className="product__discount__item__pic set-bg" style={{ backgroundImage: 'url(images/department/oatmeal/oatmeal01.jpg)',
      ...
      <Col lg={4} md={6} sm={12}>
        <div className="product__discount__item">
          <div className="product__discount__item__pic set-bg" style={{ backgroundImage: 'url(images/department/oatmeal/oatmeal02.jpg)',
                                                                                        backgroundSize: 'cover',
                                                                                        backgroundPosition: 'center',
                                                                                        width: '100%',
           }}>
      ...
      <Col lg={4} md={6} sm={12}>
        <div className="product__discount__item">
          <div className="product__discount__item__pic set-bg" style={{ backgroundImage: 'url(images/department/oatmeal/oatmeal03.jpg)',
                                                                                        backgroundSize: 'cover',
                                                                                        backgroundPosition: 'center',
                                                                                        width: '100%',
           }}>
      ...
      <Col lg={4} md={6} sm={12}>
        <div className="product__discount__item">
          <div className="product__discount__item__pic set-bg" style={{ backgroundImage: 'url(images/department/oatmeal/oatmeal04.webp)',
                                                                                        backgroundSize: 'cover',
                                                                                        backgroundPosition: 'center',
                                                                                        width: '100%',
           }}>
      ...
      <Col lg={4} md={6} sm={12}>
        <div className="product__discount__item">
          <div className="product__discount__item__pic set-bg" style={{ backgroundImage: 'url(images/department/oatmeal/oatmeal05.avif)',
                                                                                        backgroundSize: 'cover',
                                                                                        backgroundPosition: 'center',
                                                                                        width: '100%',
           }}>
      ...
      <Col lg={4} md={6} sm={12}>
        <div className="product__discount__item">
          <div className="product__discount__item__pic set-bg" style={{ backgroundImage: 'url(images/department/oatmeal/oatmeal06.webp)',
                                                                                        backgroundSize: 'cover',
                                                                                        backgroundPosition: 'center',
                                                                                        width: '100%',
           }}>
          ...
          <div className="product__discount__item__text">
                <h5><a href="#">Mixed Berry Oatmeal</a></h5>
            <div className="product__item__price">$30.00 </div>
          </div>
        </div><br/>
      </Col>
